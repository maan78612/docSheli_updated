...
class PatientOnBoarding extends StatefulWidget {
  @override
  _PatientOnBoardingState createState() => _PatientOnBoardingState();
}
          ...
          child: PageView(
            ...
            children: [
              AppConfig.widgets.onBoardingCard(
                  "Find your Doctor", AppConfig.images.patientOnBoard1),
              AppConfig.widgets.onBoardingCard("Store your Medical Records",
                  AppConfig.images.patientOnBoard2),
              AppConfig.widgets.onBoardingCard(
                  "Book Appointment", AppConfig.images.patientOnBoard3),
            ],
          ),
        ),
      );
